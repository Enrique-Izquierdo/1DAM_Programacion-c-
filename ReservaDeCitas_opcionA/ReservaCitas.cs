...
namespace ReservaDeCitasMedicas
{
    class ReservaCitas
    {
        ...
        private string ValidarRespuesta(string respuesta, string caracterSalida, int min, int max)
        {
